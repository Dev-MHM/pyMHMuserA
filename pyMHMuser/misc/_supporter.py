...
from pyMHMuser.misc._decorators import mhmuser_cmd
from pyMHMuser.misc._wrappers import eod, eor

from .. import *
from ..dB._core import LIST
from . import CMD_HELP, SUDO_M  # ignore: pylint

ALIVE_NAME = mhmuser_bot.me.first_name
BOTLOG_CHATID = BOTLOG = udB.get_key("LOG_CHANNEL")


bot = borg = friday = mhmuser_bot
