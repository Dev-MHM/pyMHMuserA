...
from .. import LOGS, asst, mhmuser_bot
from . import append_or_update, owner_and_sudos

OWNER = mhmuser_bot.full_name

MSG = f"""
**MHMuser - UserBot**
➖➖➖➖➖➖➖➖➖➖
**Owner**: [{OWNER}](tg://user?id={mhmuser_bot.uid})
**Support**: @MHMuser
➖➖➖➖➖➖➖➖➖➖
"""
...
IN_BTTS = [
    [
        ...
        Button.url("Support", url="https://t.me/MHMsupport"),
    ]
]
...
def callback(data=None, from_users=[], owner=False, **kwargs):
    ...
    if "me" in from_users:
        ...
        from_users.append(mhmuser_bot.uid)
                ...
                res = [
                    await event.builder.article(
                        ...
                        thumb=InputWebDocument(
                            "https://telegra.ph/file/17b15b9c3ab47584d4910.jpg",
                            0,
                            "image/jpeg",
                            [],
                        ),
