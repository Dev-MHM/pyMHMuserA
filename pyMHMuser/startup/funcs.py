...
async def autobot():
    ...
    bf = "@BotFather"
    await mhmuser_bot(UnblockRequest(bf))
    await mhmuser_bot.send_message(bf, "/cancel")
    await asyncio.sleep(1)
    await mhmuser_bot.send_message(bf, "/newbot")
    await asyncio.sleep(1)
    isdone = (await mhmuser_bot.get_messages(bf, limit=1))[0].text
    if isdone.startswith("That I cannot do.") or "20 bots" in isdone:
        ...
        sys.exit(1)
    await mhmuser_bot.send_message(bf, name)
    await asyncio.sleep(1)
    isdone = (await mhmuser_bot.get_messages(bf, limit=1))[0].text
    if not isdone.startswith("Good."):
        await mhmuser_bot.send_message(bf, "My Assistant Bot")
        await asyncio.sleep(1)
        isdone = (await mhmuser_bot.get_messages(bf, limit=1))[0].text
        if not isdone.startswith("Good."):
            LOGS.info(
            ...
            sys.exit(1)
    await mhmuser_bot.send_message(bf, username)
    await asyncio.sleep(1)
    isdone = (await mhmuser_bot.get_messages(bf, limit=1))[0].text
    await mhmuser_bot.send_read_acknowledge("botfather")
    if isdone.startswith("Sorry,"):
        ran = randint(1, 100)
        username = "ultroid_" + (str(who.id))[6:] + str(ran) + "_bot"
        await mhmuser_bot.send_message(bf, username)
        await asyncio.sleep(1)
        nowdone = (await mhmuser_bot.get_messages(bf, limit=1))[0].text
        if nowdone.startswith("Done!"):
            token = nowdone.split("`")[1]
            udB.set_key("BOT_TOKEN", token)
            await mhmuser_bot.send_message(bf, "/setinline")
            await asyncio.sleep(1)
            await mhmuser_bot.send_message(bf, f"@{username}")
            await asyncio.sleep(1)
            await mhmuser_bot.send_message(bf, "Search")
...
async def autopilot():
    from .. import asst, udB, mhmuser_bot
    ...
    if channel:
        try:
            chat = await mhmuser_bot.get_entity(channel)
        except BaseException:
    ...
    assistant = True
    try:
        await mhmuser_bot.get_permissions(int(channel), asst.me.username)
    except UserNotParticipantError:
        try:
            await mhmuser_bot(InviteToChannelRequest(int(channel), [asst.me.username]))
        except BaseException as er:
    ...
    if isinstance(chat.photo, ChatPhotoEmpty):
        photo = await download_file(
            "https://telegra.ph/file/e70f25b0a2cc1a3da00dc.jpg", "channelphoto.jpg"
        )
        ll = await mhmuser_bot.upload_file(photo)
        try:
            await mhmuser_bot(
...
async def customize():
    ...
    try:
        ...
        if not mhmuser_bot.me.username:
            sir = mhmuser_bot.me.first_name
        else:
            sir = f"@{mhmuser_bot.me.username}"
        file = random.choice(
            [
                "https://telegra.ph/file/c96534c26db0f43b3fd88.jpg",
                "https://telegra.ph/file/c96534c26db0f43b3fd88.jpg",
        ...
        await asyncio.sleep(1)
        await mhmuser_bot.send_message("botfather", "/cancel")
        await asyncio.sleep(1)
        await mhmuser_bot.send_message("botfather", "/setuserpic")
        await asyncio.sleep(1)
        await mhmuser_bot.send_message("botfather", UL)
        await asyncio.sleep(1)
        await mhmuser_bot.send_file("botfather", file)
        await asyncio.sleep(2)
        await mhmuser_bot.send_message("botfather", "/setabouttext")
        await asyncio.sleep(1)
        await mhmuser_bot.send_message("botfather", UL)
        await asyncio.sleep(1)
        await mhmuser_bot.send_message(
            "botfather", f"✨ Hello ✨!! I'm Assistant Bot of {sir}"
        )
        await asyncio.sleep(2)
        await mhmuser_bot.send_message("botfather", "/setdescription")
        await asyncio.sleep(1)
        await mhmuser_bot.send_message("botfather", UL)
        await asyncio.sleep(1)
        await mhmuser_bot.send_message(
...
async def plug(plugin_channels):
    ...
    for chat in plugin_channels:
        LOGS.info(f"{'•'*4} {chat}")
        try:
            async for x in mhmuser_bot.iter_messages(
...
• Here, are the Some Basic stuff from, where you can Know, about its Usage."""
        PHOTO = "https://telegra.ph/file/3f311644635364649b2ec.jpg"
        BTTS = Button.inline("• Click to Start •", "initft_2")
        udB.set_key("INIT_DEPLOY", "Done")
    else:
        MSG = f"**Ultroid has been deployed!**\n➖➖➖➖➖➖➖➖➖\n**UserMode**: {inline_mention(mhmuser_bot.me)}\n**Assistant**: @{asst.me.username}\n➖➖➖➖➖➖➖➖➖\n**Support**: @MHMuser\n➖➖➖➖➖➖➖➖➖"
        BTTS, PHOTO = None, None
        prev_spam = udB.get_key("LAST_UPDATE_LOG_SPAM")
        if prev_spam:
            try:
                await mhmuser_bot.delete_messages(chat_id, int(prev_spam))
            except Exception as E:
    ...
    try:
        ...
        try:
            await (await mhmuser_bot.send_message(chat_id, str(e))).delete()
            spam_sent = await asst.send_message(chat_id, MSG, file=PHOTO, buttons=BTTS)
        ...
        LOGS.info(el)
        try:
            spam_sent = await mhmuser_bot.send_message(chat_id, MSG)
    ...
    try:
        ...
        await mhmuser_bot(JoinChannelRequest("@MHMuser"))
